...
async function run() {
    try {
        ...
        const { data: { id } } = await github.repos.createDeployment(Object.assign(Object.assign({}, context.repo), { ref: context.sha, environment: 'staging', required_contexts: [] }));
        info('deployment_id: ' + id);
        github.repos.createDeploymentStatus(Object.assign(Object.assign({}, context.repo), { deployment_id: id, state: "in_progress" }));
        ...
        github.repos.createDeploymentStatus(Object.assign(Object.assign({}, context.repo), { deployment_id: id, state: status, environment_url: url, log_url: 'https://example.com?log' }));
        setOutput('url', url);
    }
    catch (e) {
