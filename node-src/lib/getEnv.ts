export interface Env {
  ...
  CHROMATIC_GITHUB_UI_TESTS_COMMIT_STATUS_CONTEXT: string;
}
...
const {
  ...
  CHROMATIC_GITHUB_UI_TESTS_COMMIT_STATUS_CONTEXT = 'UI Tests',
} = process.env;
...
export default () =>
  ({
    ...
    STORYBOOK_NODE_ENV,
    CHROMATIC_GITHUB_UI_TESTS_COMMIT_STATUS_CONTEXT,
  } as Env);
