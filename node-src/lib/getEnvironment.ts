export interface Environment {
  ...
  CHROMATIC_TURBOSNAP_DISABLE_HASHES: boolean;
...
const {
  ...
  CHROMATIC_RETRIES = '5',
  CHROMATIC_SHARE_PROGRESS_INTERVAL = String(100),
  CHROMATIC_STORYBOOK_VERSION,
  CHROMATIC_TIMEOUT = String(5 * 60 * 1000),
  CHROMATIC_TURBOSNAP_DISABLE_HASHES,
  CHROMATIC_TURBOSNAP_MANIFEST_CONCURRENCY = String(20),
...
export default function getEnvironment(): Environment {
  return {
    ...
    CHROMATIC_SHARE_PROGRESS_INTERVAL: Number.parseInt(CHROMATIC_SHARE_PROGRESS_INTERVAL, 10),
    CHROMATIC_STORYBOOK_VERSION,
    CHROMATIC_TIMEOUT: Number.parseInt(CHROMATIC_TIMEOUT, 10),
    CHROMATIC_TURBOSNAP_DISABLE_HASHES: CHROMATIC_TURBOSNAP_DISABLE_HASHES === 'true',
    CHROMATIC_TURBOSNAP_MANIFEST_CONCURRENCY: Number.parseInt(
      CHROMATIC_TURBOSNAP_MANIFEST_CONCURRENCY,
      10
    ),
