...
const {
  CHROMATIC_DEPENDENCY_BASELINE_CONCURRENCY = String(200),
  CHROMATIC_DEPENDENCY_PACKAGE_CONCURRENCY = String(200),
...
export default function getEnvironment(): Environment {
  return {
    CHROMATIC_DEPENDENCY_BASELINE_CONCURRENCY: Number.parseInt(
      CHROMATIC_DEPENDENCY_BASELINE_CONCURRENCY,
      10
    ),
    CHROMATIC_DEPENDENCY_PACKAGE_CONCURRENCY: Number.parseInt(
